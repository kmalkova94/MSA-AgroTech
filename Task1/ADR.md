...
| NFR1 | Расширяемость функционала без изменений существующего |
| NFR1 | Высокая производительность, оповещение о нештатной ситуации не более чем через 5 секунд после возникновения инцидента |
| NFR1 | Реагирование системы видеоаналитики в реальном времени (миллисекунды) |
| NFR1 | Камеры должны уметь снимать в темное время суток |
|||
